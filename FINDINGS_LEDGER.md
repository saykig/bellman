...
**Verdict:** `KL3V2_STOP_CONVENTIONAL_SUFFICES`

- Strong conventional analysis preserved the same decision-sufficient structure as the specially instructed D preparation method in the preregistered Phase 1 cases.
- D is retired as a distinct analysis methodology for this tested wedge.
- Decision sufficiency remains useful only as a property of a representation relative to a stated downstream use.
